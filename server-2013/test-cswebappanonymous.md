...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Hh690041(v=OCS.15)
ms:contentKeyID: 49307776
ms.date: 05/19/2016
...
Verifies that anonymous users can use the Lync Web App to join a Lync Server conference. Este cmdlet foi introduzido no Lync Server 2010.
