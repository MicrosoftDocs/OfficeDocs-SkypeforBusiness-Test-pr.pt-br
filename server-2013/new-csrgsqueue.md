...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg398989(v=OCS.15)
ms:contentKeyID: 49308364
ms.date: 05/19/2016
...
Creates a new Response Group queue. With the Aplicativo Grupo de Resposta, phone calls are put in a queue and callers are placed on hold until a Response Group agent is available to answer that call. Este cmdlet foi introduzido no Lync Server 2010.
