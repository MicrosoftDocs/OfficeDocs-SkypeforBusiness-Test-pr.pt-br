...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ204711(v=OCS.15)
ms:contentKeyID: 49306008
ms.date: 05/19/2016
...
Removes an existing collection of reporting configuration settings. Reporting configuration settings are used to specify the URL for installations of Lync Server 2013 Monitoring Reports. Este cmdlet foi introduzido no Lync Server 2013.
...
**Painel de Controle do Lync Server:** The functions carried out by the **Remove-CsReportingConfiguration** cmdlet are not available in the Painel de Controle do Lync Server.
