...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ205289(v=OCS.15)
ms:contentKeyID: 49308150
ms.date: 05/19/2016
...
Verifies the status of the replica service on the local computer. The replica service is used to replicate information among all the Lync Server 2013 computers in your topology. Este cmdlet foi introduzido no Lync Server 2013.
...
**Painel de Controle do Lync Server:** The functions carried out by the **Test-CsReplica** cmdlet are not available in the Painel de Controle do Lync Server.
