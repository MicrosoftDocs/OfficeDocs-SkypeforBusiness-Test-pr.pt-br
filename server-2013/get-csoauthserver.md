...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ205238(v=OCS.15)
ms:contentKeyID: 49308012
ms.date: 05/19/2016
...
Returns information about the Open Authorization (OAuth) servers configured for use by the organization. OAuth servers, also known as security token servers, issue security tokens used in server-to-server authentication and authorization. Este cmdlet foi introduzido no Lync Server 2013.
...
**Painel de Controle do Lync Server:** The functions carried out by the **Get-CsOAuthServer** cmdlet are not available in the Painel de Controle do Lync Server.
