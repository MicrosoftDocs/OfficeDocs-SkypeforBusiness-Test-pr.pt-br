...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ205337(v=OCS.15)
ms:contentKeyID: 49308413
ms.date: 05/19/2016
...
Converts exported user data to the data format used by either Microsoft Lync Server 2010 or Lync Server 2013. Este cmdlet foi introduzido no Lync Server 2013.
...
**Painel de Controle do Lync Server:** The functions carried out by the **Convert-CsUserData** cmdlet are not available in the Painel de Controle do Lync Server.
