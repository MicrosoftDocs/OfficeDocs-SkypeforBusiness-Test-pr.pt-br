...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg398580(v=OCS.15)
ms:contentKeyID: 49307152
ms.date: 05/19/2016
...
Modifies an existing collection of media settings. Este cmdlet foi introduzido no Lync Server 2010.
...
<td><p>Optional</p></td>
<td><p>System.Boolean</p></td>
<td><p>By default, the Servidor de Mediação does not negotiate Siren as a possible codec for calls between itself and other Lync clients. If this setting is True, Siren will be included as a possible codec for use between the Servidor de Mediação and other Lync clients.</p></td>
</tr>
<tr class="even">
