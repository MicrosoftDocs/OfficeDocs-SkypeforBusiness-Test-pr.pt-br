...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ204660(v=OCS.15)
ms:contentKeyID: 49305826
ms.date: 05/19/2016
...
**Painel de Controle do Lync Server:** To remove a Persistent Chat category using the Painel de Controle do Lync Server, click **Persistent Chat** and then click **Category**. Select the category to be removed, click **Edit** and then click **Delete**.
