...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg412722(v=OCS.15)
ms:contentKeyID: 49307606
ms.date: 05/19/2016
...
Modifies a hosted voice mail policy. Este cmdlet foi introduzido no Lync Server 2010.
...
This command modifies the Destination property of a hosted voice mail policy named ExRedmond. It sets the UM do Exchange destination for this policy to be at FQDN ExUM.contoso.com.
...
This cmdlet modifies a policy that configures a user account enabled for Lync Server or Microsoft Office Communications Server to use an Unificação de Mensagens (UM) do Exchange hosted voice mail service. The policy determines how to route unanswered calls to the user to a hosted UM do Exchange service.
...
<td><p>Permite passar uma referência a um objeto para o cmdlet, em vez de definir valores de parâmetros individuais. The object must be of type HostedVoicemailPolicy and can be retrieved by calling the <strong>Get-CsHostedVoicemailPolicy</strong> cmdlet.</p></td>
</tr>
<tr class="odd">
