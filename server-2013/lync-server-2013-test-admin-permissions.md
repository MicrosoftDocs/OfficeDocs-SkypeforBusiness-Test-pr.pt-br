...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Dn767945(v=OCS.15)
ms:contentKeyID: 62486276
ms.date: 05/19/2016
...
For more information on OU permissions, see the article [Herança de permissões está desabilitado em computadores, usuários ou contêiners InetOrgPerson no Lync Server 2013](lync-server-2013-permissions-inheritance-is-disabled-on-computers-users-or-inetorgperson-containers.md).
