...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg413019(v=OCS.15)
ms:contentKeyID: 49308578
ms.date: 12/10/2016
...
Creates a new conferencing policy for use in your organization. Conferencing policies determine the features and capabilities that can be used in a conference; this includes everything from whether or not the conference can include IP audio and video to the maximum number of people who can attend a meeting. Este cmdlet foi introduzido no Lync Server 2010.
