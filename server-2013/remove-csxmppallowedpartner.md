...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ205055(v=OCS.15)
ms:contentKeyID: 49307342
ms.date: 05/19/2016
...
**Painel de Controle do Lync Server:** To remove an XMPP allowed partner using the Painel de Controle do Lync Server, click External User Access and then click XMPP Federated Partners. Select the partner to be removed, click Edit, and then click Delete.
