...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ204907(v=OCS.15)
ms:contentKeyID: 49306783
ms.date: 05/19/2016
...
Assigns a per-user Persistent Chat policy to a user. Persistent Chat policies determine whether or not users are allowed access to Persistent Chat chat rooms. Este cmdlet foi introduzido no Lync Server 2013.
...
**Painel de Controle do Lync Server:** To assign a Persistent Chat policy to a user in the Painel de Controle do Lync Server, double-click the appropriate user account. In the **Edit Lync Server User** dialog box, select a policy from the **Persistent Chat policy** dropdown list and then click **Commit**.
