...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ205254(v=OCS.15)
ms:contentKeyID: 49308064
ms.date: 04/07/2017
...
**Painel de Controle do Lync Server:** The functions carried out by the **New-CsWatcherNodeConfiguration** cmdlet are not available in the Painel de Controle do Lync Server.
