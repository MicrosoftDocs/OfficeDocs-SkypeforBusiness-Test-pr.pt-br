...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg413035(v=OCS.15)
ms:contentKeyID: 49308631
ms.date: 05/19/2016
...
Retrieves information about one or more trusted application endpoints. Este cmdlet foi introduzido no Lync Server 2010.
...
A trusted application endpoint is an Active Directory contact object that enables routing of calls to a trusted application. This cmdlet retrieves one or more existing endpoint contact objects in Serviços de Domínio Active Directory.
