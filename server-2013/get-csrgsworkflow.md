...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg425766(v=OCS.15)
ms:contentKeyID: 49306214
ms.date: 05/19/2016
...
Returns information about Response Group workflows. Workflows determine the actions that are taken when the Aplicativo Grupo de Resposta receives a phone call. Este cmdlet foi introduzido no Lync Server 2010.
...
Example 2 returns information about all the Aplicativo Grupo de Resposta workflows found on the service ApplicationServer:atl-cs-001.litwareinc.com.
