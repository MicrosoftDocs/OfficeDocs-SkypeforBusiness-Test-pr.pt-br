...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg425893(v=OCS.15)
ms:contentKeyID: 49306450
ms.date: 05/19/2016
...
Creates a new collection of Registrar configuration settings. Registrars are used to authenticate logon requests and to maintain information about user status and availability. Este cmdlet foi introduzido no Lync Server 2010.
