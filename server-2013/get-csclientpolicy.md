...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg398830(v=OCS.15)
ms:contentKeyID: 49308071
ms.date: 05/19/2016
...
Returns information about the client policies configured for use in your organization. Among other things, client policies help determine the features of Lync that are available to users; for example, you might give some users the right to transfer files while denying this right to other users. Este cmdlet foi introduzido no Lync Server 2010.
...
<td><p>Retrieves the client policy data from the local replica of the Repositório de Gerenciamento Central rather than from the Repositório de Gerenciamento Central itself.</p></td>
</tr>
</tbody>
</table>
