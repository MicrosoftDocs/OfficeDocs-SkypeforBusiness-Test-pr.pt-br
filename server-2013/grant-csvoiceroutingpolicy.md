...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ205141(v=OCS.15)
ms:contentKeyID: 49307720
ms.date: 05/19/2016
...
**Painel de Controle do Lync Server:** The functions carried out by the Grant-CsVoiceRoutingPolicy cmdlet are not available in the Painel de Controle do Lync Server.
