...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg398486(v=OCS.15)
ms:contentKeyID: 49306978
ms.date: 05/19/2016
...
Creates a new workflow prompt for the Aplicativo Grupo de Resposta. A workflow prompt is either an audio file that is played or text that is read aloud in order to supply callers with additional information. Este cmdlet foi introduzido no Lync Server 2010.
