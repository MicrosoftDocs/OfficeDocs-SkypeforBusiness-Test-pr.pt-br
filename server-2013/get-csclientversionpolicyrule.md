...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg413048(v=OCS.15)
ms:contentKeyID: 49308654
ms.date: 05/19/2016
...
Returns the client version policy rules configured for use in your organization. Este cmdlet foi introduzido no Lync Server 2010.
...
<td><p>Retrieves the client version policy rule data from the local replica of the Repositório de Gerenciamento Central rather than from the Repositório de Gerenciamento Central itself.</p></td>
</tr>
</tbody>
</table>
