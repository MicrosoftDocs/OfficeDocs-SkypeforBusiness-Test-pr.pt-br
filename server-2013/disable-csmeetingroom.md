...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ204723(v=OCS.15)
ms:contentKeyID: 49306051
ms.date: 05/19/2016
...
Disables a Lync Server 2013 meeting room. A meeting room is a conferencing device designed to address video conferencing and collaboration scenarios in small conference rooms. When you disable a meeting room object you remove all the Lync Server-specific Active Directory attributes assigned to the user account that represents the meeting room. However, the Active Directory user account itself is not deleted. Este cmdlet foi introduzido no Lync Server 2013.
...
**Painel de Controle do Lync Server:** The functions carried out by the **Disable-CsMeetingRoom** cmdlet are not available in the Painel de Controle do Lync Server.
