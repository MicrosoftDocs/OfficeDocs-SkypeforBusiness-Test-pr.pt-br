...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg412727(v=OCS.15)
ms:contentKeyID: 49307595
ms.date: 05/19/2016
...
Retrieves one or more bandwidth policy service configurations. Este cmdlet foi introduzido no Lync Server 2010.
...
<td><p>Retrieves the bandwidth policy service configuration from the local replica of the Repositório de Gerenciamento Central, rather than from the Repositório de Gerenciamento Central itself.</p></td>
</tr>
</tbody>
</table>
