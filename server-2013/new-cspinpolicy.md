...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg398935(v=OCS.15)
ms:contentKeyID: 49308248
ms.date: 05/19/2016
...
Creates a new client personal identification number (PIN) policy. PIN authentication enables users to access Lync Server by providing a PIN instead of a user name and password. Este cmdlet foi introduzido no Lync Server 2010.
