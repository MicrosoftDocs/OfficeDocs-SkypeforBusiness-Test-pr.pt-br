...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ205206(v=OCS.15)
ms:contentKeyID: 49307923
ms.date: 05/19/2016
...
Creates a new Open Authorization (OAuth) server for use by the organization. OAuth servers, also known as security token servers, issue security tokens used in server-to-server authentication and authorization. Este cmdlet foi introduzido no Lync Server 2013.
...
**Painel de Controle do Lync Server:** The functions carried out by the New-CsOAuthServer cmdlet are not available in the Painel de Controle do Lync Server.
