...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg398574(v=OCS.15)
ms:contentKeyID: 49307145
ms.date: 05/19/2016
...
Returns information about the configuration settings for computers running the Serviço de Borda de Acesso in your organization (also known as Access Edge servers). Access Edge servers provide a way for users outside your internal network to communicate with users inside your internal network. Este cmdlet foi introduzido no Lync Server 2010.
...
<td><p>Retrieves the Access Edge configuration data from the local replica of the Repositório de Gerenciamento Central rather than from the Repositório de Gerenciamento Central itself.</p></td>
</tr>
</tbody>
</table>
