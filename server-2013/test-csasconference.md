...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ205227(v=OCS.15)
ms:contentKeyID: 49307980
ms.date: 05/19/2016
...
Tests the ability of a pair of users to take part in an application sharing conference. Este cmdlet foi introduzido no Lync Server 2013.
...
**Painel de Controle do Lync Server:** The functions carried out by the Test-CsASConference cmdlet are not available in the Painel de Controle do Lync Server.
