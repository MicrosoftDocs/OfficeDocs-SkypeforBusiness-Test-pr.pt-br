...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg398786(v=OCS.15)
ms:contentKeyID: 49307553
ms.date: 05/19/2016
...
Enables you to remove an existing collection of configuration settings applied to computers running the Serviço de Borda de Acesso (these computers are also known as A/V Edge servers). An A/V Edge server enables internal users to share audio and video data with external users (that is, users who are not logged on to your internal network). Este cmdlet foi introduzido no Lync Server 2010.
