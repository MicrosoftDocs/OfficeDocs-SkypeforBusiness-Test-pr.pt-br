...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg412766(v=OCS.15)
ms:contentKeyID: 49307681
ms.date: 05/19/2016
...
Removes an existing Lync Server announcement. Announcements are played when users dial a valid but unassigned phone number. An announcement can be a message (such as "This number is temporarily out of service") or a busy signal. Este cmdlet foi introduzido no Lync Server 2010.
...
<p>- Enter the Identity of the Serviço de aplicativos for the announcements you want to remove. This will remove all announcements configured with the given service Identity. For example, ApplicationServer:Redmond.litwareinc.com.</p>
