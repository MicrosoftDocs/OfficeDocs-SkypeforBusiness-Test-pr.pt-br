...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg425813(v=OCS.15)
ms:contentKeyID: 49306294
ms.date: 05/19/2016
...
Creates a new simple URL configuration collection. Simple URLs make it easier for users to join meetings and conferences. They also make it easier for Administrators to sign in to the Painel de Controle do Lync Server. Este cmdlet foi introduzido no Lync Server 2010.
