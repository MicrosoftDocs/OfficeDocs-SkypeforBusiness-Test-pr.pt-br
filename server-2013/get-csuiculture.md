...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg412900(v=OCS.15)
ms:contentKeyID: 49307903
ms.date: 05/19/2016
...
Returns information about the culture (that is, the language and regional settings) used by the Shell de Gerenciamento do Lync Server. Este cmdlet foi introduzido no Lync Server 2010.
