...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ205373(v=OCS.15)
ms:contentKeyID: 49308602
ms.date: 05/19/2016
...
Imports user data previously exported by using the Export-CsUserData cmdlet. Este cmdlet foi introduzido no Lync Server 2013.
...
**Painel de Controle do Lync Server:** The functions carried out by the **Import-CsUserData** cmdlet are not available in the Painel de Controle do Lync Server.
