...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg398320(v=OCS.15)
ms:contentKeyID: 49306677
ms.date: 05/19/2016
...
Modifies a collection of Serviço Web de Atualização de Dispositivos configuration settings. These settings are used to manage the Serviço Web de Atualização de Dispositivos, a Lync Server component that enables administrators to distribute firmware updates to telephones and other devices running Lync Server. Este cmdlet foi introduzido no Lync Server 2010.
