...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg425899(v=OCS.15)
ms:contentKeyID: 49306472
ms.date: 05/19/2016
...
Creates a new device update management test device. Test devices provide a way for administrators to test firmware updates before those updates are distributed to all the devices in an organization. Este cmdlet foi introduzido no Lync Server 2010.
