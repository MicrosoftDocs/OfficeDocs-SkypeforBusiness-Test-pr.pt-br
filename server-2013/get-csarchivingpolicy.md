...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg425731(v=OCS.15)
ms:contentKeyID: 49306163
ms.date: 05/19/2016
...
Returns information about your instant messaging (IM) session archiving policies. Archiving policies enable you to archive all IM and web conferencing sessions that take place between internal users and/or between internal users and external users. Este cmdlet foi introduzido no Lync Server 2010.
...
<td><p>Retrieves the archiving policy data from the local replica of the Repositório de Gerenciamento Central rather than from the Repositório de Gerenciamento Central itself.</p></td>
</tr>
</tbody>
</table>
