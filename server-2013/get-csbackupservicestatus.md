...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ205032(v=OCS.15)
ms:contentKeyID: 49307258
ms.date: 05/19/2016
...
Returns information about the current state of the backup service for a specified pool. Este cmdlet foi introduzido no Lync Server 2013.
...
**Painel de Controle do Lync Server:** The functions carried out by the **Get-CsBackupServiceStatus** cmdlet are not available in the Painel de Controle do Lync Server.
