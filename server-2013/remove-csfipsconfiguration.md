...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ205201(v=OCS.15)
ms:contentKeyID: 49307899
ms.date: 05/19/2016
...
**Painel de Controle do Lync Server:** The functions carried out by the Remove-CsFIPSConfiguration cmdlet are not available in the Painel de Controle do Lync Server.
