...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ205159(v=OCS.15)
ms:contentKeyID: 49307698
ms.date: 05/19/2016
...
Uninstalls a Shell de Gerenciamento do Lync Server 2013 mirror database. A database mirror enables you to simultaneously maintain two copies of a database, each copy residing on a different server. Este cmdlet foi introduzido no Lync Server 2013.
...
Painel de Controle do Lync Server: The functions carried out by the **Uninstall-CsMirrorDatabase** cmdlet are not available in the Painel de Controle do Lync Server.
