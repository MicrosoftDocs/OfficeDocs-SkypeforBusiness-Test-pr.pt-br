...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg413034(v=OCS.15)
ms:contentKeyID: 49308624
ms.date: 05/19/2016
...
<td><p>Retrieves the diagnostic configuration data from the local replica of the Repositório de Gerenciamento Central rather than from the Repositório de Gerenciamento Central itself.</p></td>
</tr>
</tbody>
</table>
