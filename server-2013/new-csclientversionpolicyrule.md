...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg398905(v=OCS.15)
ms:contentKeyID: 49308208
ms.date: 05/19/2016
...
Creates a new client version policy rule. Client version policy rules help determine whether users can use a specific client application to log on to Lync Server. Este cmdlet foi introduzido no Lync Server 2010.
