...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ204811(v=OCS.15)
ms:contentKeyID: 49306423
ms.date: 05/19/2016
...
Creates a new Persistent Chat endpoint. A Persistent Chat endpoint is an Active Directory contact object provides a friendly URL for a Lync Server 2013 Persistent Chat pool. Este cmdlet foi introduzido no Lync Server 2013.
...
**Painel de Controle do Lync Server:** The functions carried out by the **New-CsPersistentChatEndpoint** cmdlet are not available in the Painel de Controle do Lync Server.
