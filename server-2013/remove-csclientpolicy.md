...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg425772(v=OCS.15)
ms:contentKeyID: 49306238
ms.date: 05/19/2016
...
Removes an existing client policy. Among other things, client policies help determine the features of Lync that are available to users; for example, you might give some users the right to transfer files while denying this right to other users. Este cmdlet foi introduzido no Lync Server 2010.
