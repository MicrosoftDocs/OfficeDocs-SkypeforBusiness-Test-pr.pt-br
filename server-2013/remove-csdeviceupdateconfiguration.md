...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg425933(v=OCS.15)
ms:contentKeyID: 49306535
ms.date: 05/19/2016
...
Removes the specified device update configuration settings. These settings help manage the Serviço Web de Atualização de Dispositivos, a Lync Server component that enables administrators to distribute firmware updates to telephones and other devices running Lync Phone Edition. Este cmdlet foi introduzido no Lync Server 2010.
