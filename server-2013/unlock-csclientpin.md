...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg412982(v=OCS.15)
ms:contentKeyID: 49308527
ms.date: 05/19/2016
...
Enables an administrator to unlock the personal identification number (PIN) for a specified user. Este cmdlet foi introduzido no Lync Server 2010.
