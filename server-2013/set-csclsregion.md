...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ204746(v=OCS.15)
ms:contentKeyID: 49306157
ms.date: 05/19/2016
...
Modifies an existing centralized logging configuration region. Centralized logging provides a way for administrators to simultaneously enable or disable event tracing on multiple computers. Este cmdlet foi introduzido no Lync Server 2013.
...
**Painel de Controle do Lync Server:** The functions carried out by the **Set-CsClsRegion** cmdlet are not available in the Painel de Controle do Lync Server.
