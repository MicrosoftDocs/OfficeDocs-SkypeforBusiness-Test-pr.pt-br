...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg398644(v=OCS.15)
ms:contentKeyID: 49307268
ms.date: 05/19/2016
...
Modifies an existing dial plan. Este cmdlet foi introduzido no Lync Server 2010.
...
<td><p>Permite passar uma referência a um objeto para o cmdlet, em vez de definir valores de parâmetros individuais. You can retrieve this object reference by calling the <strong>Get-CsDialPlan</strong> cmdlet.</p></td>
</tr>
<tr class="even">
