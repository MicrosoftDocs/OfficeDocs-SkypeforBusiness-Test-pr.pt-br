...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ205109(v=OCS.15)
ms:contentKeyID: 49307586
ms.date: 05/19/2016
...
Modifies the state of a Persistent Chat service pool. Persistent Chat pools can be in one of two states: Normal, in which the pool uses its primary databases; or FailedOver, in which the pool uses the backup databases defined in the topology. Este cmdlet foi introduzido no Lync Server 2013.
...
**Painel de Controle do Lync Server:** The functions carried out by the **Set-CsPersistentChatState** cmdlet are not available in the Painel de Controle do Lync Server.
