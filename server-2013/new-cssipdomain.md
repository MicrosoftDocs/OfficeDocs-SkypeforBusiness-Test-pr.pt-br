...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg425857(v=OCS.15)
ms:contentKeyID: 49306392
ms.date: 05/19/2016
...
Creates a new SIP domain for use in your organization. SIP domains are domains authorized to send and receive SIP traffic, and are used when assigning SIP addresses to users. Este cmdlet foi introduzido no Lync Server 2010.
