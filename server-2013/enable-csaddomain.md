...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg412764(v=OCS.15)
ms:contentKeyID: 49307670
ms.date: 05/19/2016
...
Modifies the security settings on the universal groups created during forest preparation. These modifications provide the permissions needed to host and manage users enabled for Lync Server within the domain. Este cmdlet foi introduzido no Lync Server 2010.
