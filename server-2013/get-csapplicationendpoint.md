...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg398655(v=OCS.15)
ms:contentKeyID: 49307294
ms.date: 05/19/2016
...
Retrieves endpoints for the Serviço de aplicativos. Este cmdlet foi introduzido no Lync Server 2010.
...
This cmdlet retrieves one or more application contacts from Serviços de Domínio Active Directory. These objects are stored in Active Directory in the Application Contacts container of the RTC service.
