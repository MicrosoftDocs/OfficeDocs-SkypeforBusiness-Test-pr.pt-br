...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ205232(v=OCS.15)
ms:contentKeyID: 49307991
ms.date: 05/19/2016
...
Verifies replication between Active Directory and the Lync Server 2013 Address book service. Este cmdlet foi introduzido no Lync Server 2013.
...
**Painel de Controle do Lync Server:** The functions carried out by the D**ebug-CsAddressBookReplication** cmdlet are not available in the Painel de Controle do Lync Server.
