...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ205189(v=OCS.15)
ms:contentKeyID: 49307868
ms.date: 05/19/2016
...
Invokes the failover process for a Lync Server 2013 pool. Failover refers to the process that occurs when a pool fails and the current users of that pool are then signed on to a backup pool. Este cmdlet foi introduzido no Lync Server 2013.
...
**Painel de Controle do Lync Server:** The functions carried out by the **Invoke-CsPoolFailOver** cmdlet are not available in the Painel de Controle do Lync Server.
