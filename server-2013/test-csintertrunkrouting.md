...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ204741(v=OCS.15)
ms:contentKeyID: 49306126
ms.date: 05/19/2016
...
Verifies the route and the PSTN usage used when routing a phone call made from a specified SIP trunk. Este cmdlet foi introduzido no Lync Server 2013.
...
**Painel de Controle do Lync Server:** The functions carried out by the Test-CsInterTrunkRouting cmdlet are not available in the Painel de Controle do Lync Server.
