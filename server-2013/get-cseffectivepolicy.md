...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ204636(v=OCS.15)
ms:contentKeyID: 49305705
ms.date: 05/19/2016
...
**Painel de Controle do Lync Server:** The functions carried out by the **Get-CsEffectivePolicy** cmdlet are not directly available in the Painel de Controle do Lync Server.
