...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ204915(v=OCS.15)
ms:contentKeyID: 49306805
ms.date: 05/19/2016
...
Returns the state of one or more Persistent Chat service pools. Persistent Chat pools can be in one of two states: Normal, in which the pool uses its primary databases; or FailedOver, in which the pool uses the backup databases defined in the topology. Este cmdlet foi introduzido no Lync Server 2013.
...
**Painel de Controle do Lync Server:** The functions carried out by the **Get-CsPersistentChatState** cmdlet are not available in the Painel de Controle do Lync Server.
