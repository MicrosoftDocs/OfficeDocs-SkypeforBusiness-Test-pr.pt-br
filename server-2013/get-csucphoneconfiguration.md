...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg398070(v=OCS.15)
ms:contentKeyID: 49305669
ms.date: 05/19/2016
...
Returns information regarding management options for Lync Phone Edition. This includes such things as the required security mode and whether or not the phone should automatically be locked after a specified period of inactivity. Este cmdlet foi introduzido no Lync Server 2010.
...
<td><p>Retrieves the UC phone configuration data from the local replica of the Repositório de Gerenciamento Central rather than from the Repositório de Gerenciamento Central itself.</p></td>
</tr>
</tbody>
</table>
