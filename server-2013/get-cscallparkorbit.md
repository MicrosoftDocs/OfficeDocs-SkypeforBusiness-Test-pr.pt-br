...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg398554(v=OCS.15)
ms:contentKeyID: 49307113
ms.date: 05/19/2016
...
Gets the call park orbit range settings for the organization. Este cmdlet foi introduzido no Lync Server 2010.
...
<td><p>Retrieves the call park orbit information from the local replica of the Repositório de Gerenciamento Central, rather than the Repositório de Gerenciamento Central itself.</p></td>
</tr>
<tr class="even">
