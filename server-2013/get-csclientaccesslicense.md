...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ204853(v=OCS.15)
ms:contentKeyID: 49306536
ms.date: 05/19/2016
...
Returns information about client license usage in your organization. Este cmdlet foi introduzido no Lync Server 2013.
...
<tbody>
<tr class="odd">
<td>For more information, and for ways to work around these issues, see the <a href="lync-server-2013-release-notes.md">Notas de versão para Lync Server 2013</a>.</td>
</tr>
</tbody>
</table>
...
**Painel de Controle do Lync Server:** The functions carried out by the **Get-CsClientAccessLicense** cmdlet are not available in the Painel de Controle do Lync Server.
