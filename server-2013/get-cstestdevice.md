...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg398304(v=OCS.15)
ms:contentKeyID: 49306648
ms.date: 05/19/2016
...
<td><p>Retrieves the test device data from the local replica of the Repositório de Gerenciamento Central rather than from the Repositório de Gerenciamento Central itself.</p></td>
</tr>
</tbody>
</table>
