...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ205138(v=OCS.15)
ms:contentKeyID: 49307634
ms.date: 05/19/2016
...
Verifies connectivity through the A/V Edge server. Este cmdlet foi introduzido no Lync Server 2013.
...
**Painel de Controle do Lync Server:** The functions carried out by the **Test-CsAVEdgeConnectivity** cmdlet are not available in the Painel de Controle do Lync Server.
