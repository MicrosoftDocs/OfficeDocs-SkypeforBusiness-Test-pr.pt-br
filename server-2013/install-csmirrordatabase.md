...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ204986(v=OCS.15)
ms:contentKeyID: 49307047
ms.date: 05/19/2016
...
Associates a mirror database with a Lync Server 2013 database. A database mirror enables you to simultaneously maintain two copies of a database, each copy residing on a different server. Este cmdlet foi introduzido no Lync Server 2013.
...
Painel de Controle do Lync Server: The functions carried out by the **Install-CsMirrorDatabase** cmdlet are not available in the Painel de Controle do Lync Server.
