...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ204803(v=OCS.15)
ms:contentKeyID: 49306386
ms.date: 05/19/2016
...
**Painel de Controle do Lync Server:** To create a new Persistent Chat category using the Painel de Controle do Lync Server, click **Persistent Chat**, click **Category**, and then click **New**.
