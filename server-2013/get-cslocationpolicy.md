...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg398911(v=OCS.15)
ms:contentKeyID: 49308195
ms.date: 05/19/2016
...
Returns information about how (or if) the Enhanced 9-1-1 (E9-1-1) Serviço de Informações de Local has been configured. The E9-1-1 service enables those who answer emergency calls to determine the caller’s geographic location. Este cmdlet foi introduzido no Lync Server 2010.
...
<td><p>Retrieves the location policy information from the local replica of the Repositório de Gerenciamento Central, rather than the Repositório de Gerenciamento Central itself.</p></td>
</tr>
</tbody>
</table>
