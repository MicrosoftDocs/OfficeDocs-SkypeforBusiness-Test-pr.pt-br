...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg412776(v=OCS.15)
ms:contentKeyID: 49307703
ms.date: 05/19/2016
...
The command shown in Example 1 returns a collection of all the multi-forest contacts found in Serviços de Domínio Active Directory. Calling the **Get-CsAdContact** cmdlet without any additional parameters returns all the property values for all the Active Directory contacts.
