...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg413002(v=OCS.15)
ms:contentKeyID: 49308573
ms.date: 05/19/2016
...
Returns information about the privacy configuration settings currently in use in your organization. Privacy configuration settings help determine how much information users make available to other users. Este cmdlet foi introduzido no Lync Server 2010.
...
<td><p>Retrieves the privacy configuration data from the local replica of the Repositório de Gerenciamento Central rather than from the Repositório de Gerenciamento Central itself.</p></td>
</tr>
<tr class="even">
