...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg398764(v=OCS.15)
ms:contentKeyID: 49307523
ms.date: 05/19/2016
...
Modifies the property values in an existing collection of Registrar configuration settings. Registrars are used to authenticate logon requests and to maintain information about user status and availability. Este cmdlet foi introduzido no Lync Server 2010.
