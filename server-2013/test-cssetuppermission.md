...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg398428(v=OCS.15)
ms:contentKeyID: 49306872
ms.date: 05/19/2016
...
Verifies that the required permissions needed to install Lync Server or one of its components have been configured on the specified Active Directory container. Este cmdlet foi introduzido no Lync Server 2010.
