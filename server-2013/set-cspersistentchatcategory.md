...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ204952(v=OCS.15)
ms:contentKeyID: 49306892
ms.date: 05/19/2016
...
Modifies an existing Persistent Chat category. A Persistent Chat category represents a collection of Persistent Chat chat rooms. Each chat room must be associated with a category. Este cmdlet foi introduzido no Lync Server 2013.
...
**Painel de Controle do Lync Server:** To modify an existing Persistent Chat category using the Painel de Controle do Lync Server, click **Persistent Chat**, click **Category**, then double-click the category to be modified.
