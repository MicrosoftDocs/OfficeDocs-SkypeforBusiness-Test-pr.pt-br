...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ205113(v=OCS.15)
ms:contentKeyID: 49307516
ms.date: 05/19/2016
...
Manually purges records from the Call Detail records (CDR) database. Este cmdlet foi introduzido no Lync Server 2013.
...
**Painel de Controle do Lync Server:** The functions carried out by the **Invoke-CsCdrDatabasePurge** cmdlet are not available in the Painel de Controle do Lync Server.
