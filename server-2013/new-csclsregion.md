...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ204658(v=OCS.15)
ms:contentKeyID: 49305814
ms.date: 05/19/2016
...
**Painel de Controle do Lync Server:** The functions carried out by the **New-CsClsRegion** cmdlet are not available in the Painel de Controle do Lync Server.
