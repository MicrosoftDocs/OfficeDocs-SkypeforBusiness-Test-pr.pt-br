...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ204829(v=OCS.15)
ms:contentKeyID: 49306482
ms.date: 05/19/2016
...
Verifies whether or not a user can employ the Lync Server 2013 Web scheduler to schedule an online meeting. Este cmdlet foi introduzido no Lync Server 2013.
...
**Painel de Controle do Lync Server:** The functions carried out by the **Test-CsWebScheduler** cmdlet are not available in the Painel de Controle do Lync Server.
