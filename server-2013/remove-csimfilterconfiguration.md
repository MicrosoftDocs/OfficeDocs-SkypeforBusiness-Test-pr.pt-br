...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg398171(v=OCS.15)
ms:contentKeyID: 49305860
ms.date: 05/19/2016
...
Removes the specified instant messaging (IM) filter configuration. (IM filter settings are used to prevent users from sending instant messages that contain hyperlinks.) Este cmdlet foi introduzido no Lync Server 2010.
