...
<tbody>
<tr class="odd">
<td><strong>*</strong>As ACEs que não são herdadas não concedem acesso aos objetos filho desses contêineres. As ACEs que são herdadas concedem acesso aos objetos filho desses contêineres.</td>
</tr>
</tbody>
</table>
