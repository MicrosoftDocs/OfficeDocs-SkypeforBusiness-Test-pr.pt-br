...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg398104(v=OCS.15)
ms:contentKeyID: 49305730
ms.date: 05/19/2016
...
Retrieves one or more outbound translation rules. An outbound translation rule converts phone numbers to the local dialing format for interaction with private branch exchange (PBX) systems and public switched telephone network (PSTN) gateways. Este cmdlet foi introduzido no Lync Server 2010.
...
<td><p>Retrieves the outbound translation rule from the local replica of the Repositório de Gerenciamento Central, rather than the Repositório de Gerenciamento Central itself.</p></td>
</tr>
</tbody>
</table>
