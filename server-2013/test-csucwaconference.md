...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ619178(v=OCS.15)
ms:contentKeyID: 49306665
ms.date: 05/19/2016
...
Tests the ability of a pair of users to schedule, join, and then conduct an online conference using the Unified Communications Web API (UCWA). Este cmdlet foi introduzido no Lync Server 2013.
...
**Painel de Controle do Lync Server:** The functions carried out by the **Test-CsUcwaConference** cmdlet are not available in the Painel de Controle do Lync Server.
