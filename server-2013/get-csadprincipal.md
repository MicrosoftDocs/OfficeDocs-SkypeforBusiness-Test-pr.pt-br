...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ205326(v=OCS.15)
ms:contentKeyID: 49308354
ms.date: 05/19/2016
...
Returns information about Active Directory principals. These principals include Active Directory objects such as users, groups, contacts, containers, and organizational units. Este cmdlet foi introduzido no Lync Server 2013.
...
**Painel de Controle do Lync Server:** The functions carried out by the Get-CsAdPrincipal cmdlet are not available in the Painel de Controle do Lync Server.
