...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ204784(v=OCS.15)
ms:contentKeyID: 49306259
ms.date: 05/19/2016
...
Verifies that a test user can connect to Exchange Unified Messaging. Este cmdlet foi introduzido no Lync Server 2013.
...
**Painel de Controle do Lync Server:** The functions carried out by the **Test-CsExUMConnectivity** cmdlet are not available in the Painel de Controle do Lync Server.
