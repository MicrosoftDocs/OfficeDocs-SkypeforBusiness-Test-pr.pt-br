...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ204771(v=OCS.15)
ms:contentKeyID: 49306263
ms.date: 05/19/2016
...
Returns information about the Persistent Chat categories in use in your organization. A Persistent Chat category represents a collection of Persistent Chat chat rooms. Each chat room must be associated with a category. Este cmdlet foi introduzido no Lync Server 2013.
...
**Painel de Controle do Lync Server:** To view Persistent Chat categories in Painel de Controle do Lync Server, click **Persistent Chat** and then click **Category**.
