...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ204740(v=OCS.15)
ms:contentKeyID: 49306107
ms.date: 05/19/2016
...
**Painel de Controle do Lync Server:** The functions carried out by the **Test-CsExStorageConnectivity** cmdlet are not available in the Painel de Controle do Lync Server.
