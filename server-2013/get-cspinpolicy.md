...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg398262(v=OCS.15)
ms:contentKeyID: 49306073
ms.date: 05/19/2016
...
Returns information about the client personal identification number (PIN) policies configured for use in your organization. PIN authentication enables users to access Lync Server by providing a PIN instead of a user name and password. Este cmdlet foi introduzido no Lync Server 2010.
...
<td><p>Retrieves the PIN policy data from the local replica of the Repositório de Gerenciamento Central rather than from the Repositório de Gerenciamento Central itself.</p></td>
</tr>
</tbody>
</table>
