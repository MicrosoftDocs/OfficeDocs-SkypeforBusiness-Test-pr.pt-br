...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ205356(v=OCS.15)
ms:contentKeyID: 49308444
ms.date: 05/19/2016
...
Returns information about the reporting configuration settings in use in the organization. Reporting configuration settings are used to specify the URL used for accessing Lync Server 2013 Monitoring Reports. Este cmdlet foi introduzido no Lync Server 2013.
...
**Painel de Controle do Lync Server:** The functions carried out by the **Get-CsReportingConfiguration** cmdlet are not available in the Painel de Controle do Lync Server.
