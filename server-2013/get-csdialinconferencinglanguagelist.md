...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg425869(v=OCS.15)
ms:contentKeyID: 49306409
ms.date: 05/19/2016
...
Returns a list of languages, including regional/minority languages, supported for use with Lync Server dial-in conferences. These languages are used to relay audio messages and instructions to users participating in a conference by using a telephone. Este cmdlet foi introduzido no Lync Server 2010.
...
<td><p>Retrieves the languages list from the local replica of the Repositório de Gerenciamento Central rather than from the Repositório de Gerenciamento Central itself.</p></td>
</tr>
</tbody>
</table>
