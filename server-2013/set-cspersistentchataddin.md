...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ204721(v=OCS.15)
ms:contentKeyID: 49306050
ms.date: 05/19/2016
...
Modifies an existing Persistent Chat add-in. A Persistent Chat add-in is a customized web page that can be embedded within a Persistent Chat client. Este cmdlet foi introduzido no Lync Server 2013.
...
**Painel de Controle do Lync Server:** To modify an existing Persistent Chat add-in using the Painel de Controle do Lync Server, click **Persistent Chat**, click **Add-in**, then double-click the add-in to be modified.
