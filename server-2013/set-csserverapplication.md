...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg412850(v=OCS.15)
ms:contentKeyID: 49307846
ms.date: 05/19/2016
...
Modifies the property values of an existing server application. Server applications are applications that are hosted by Lync Server. Este cmdlet foi introduzido no Lync Server 2010.
