...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg398540(v=OCS.15)
ms:contentKeyID: 49307079
ms.date: 05/19/2016
...
Modifies an existing collection of User Replicator configuration settings. The User Replicator periodically retrieves up-to-date user account information from Serviços de Domínio Active Directory and then synchronizes the new information with the current user data stored by Lync Server. Este cmdlet foi introduzido no Lync Server 2010.
