...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg412968(v=OCS.15)
ms:contentKeyID: 49308034
ms.date: 05/19/2016
...
Moves an existing conference directory from one pool to another. Conference directories are used to help dial-in conferencing users locate conference information. Este cmdlet foi introduzido no Lync Server 2010.
