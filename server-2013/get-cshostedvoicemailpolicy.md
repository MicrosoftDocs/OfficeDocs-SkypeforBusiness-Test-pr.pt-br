...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg398348(v=OCS.15)
ms:contentKeyID: 49306723
ms.date: 05/19/2016
...
Retrieves a hosted voice mail policy. Este cmdlet foi introduzido no Lync Server 2010.
...
This cmdlet retrieves a policy that specifies how to route unanswered calls to a user to a hosted Unificação de Mensagens (UM) do Exchange service.
...
<td><p>Retrieves the hosted voice mail policy from the local replica of the Repositório de Gerenciamento Central, rather than the Repositório de Gerenciamento Central itself.</p></td>
</tr>
<tr class="even">
