...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ619189(v=OCS.15)
ms:contentKeyID: 49307665
ms.date: 05/19/2016
...
Provides a command-line option for searching the centralized logging service log files. Este cmdlet foi introduzido no Lync Server 2013.
...
**Painel de Controle do Lync Server:** The functions carried out by the **Search-CsClsLogging** cmdlet are not available in the Painel de Controle do Lync Server.
