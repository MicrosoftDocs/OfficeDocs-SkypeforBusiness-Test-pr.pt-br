...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ204841(v=OCS.15)
ms:contentKeyID: 49306534
ms.date: 05/19/2016
...
Modifies the Open Authorization (OAuth) configuration settings currently in use in the organization. OAuth is a standard protocol used for server-to-server authentication and authorization. Este cmdlet foi introduzido no Lync Server 2013.
...
**Painel de Controle do Lync Server:** The functions carried out by the **Set-CsOAuthConfiguration** cmdlet are not available in the Painel de Controle do Lync Server.
