...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg425761(v=OCS.15)
ms:contentKeyID: 49306204
ms.date: 05/19/2016
...
Creates a new instance of device update configuration settings. These settings are used to manage the Serviço Web de Atualização de Dispositivos, a Lync Server component that enables administrators to distribute firmware updates to telephones and other devices running Lync Server. Este cmdlet foi introduzido no Lync Server 2010.
...
<td><p>Indicates the valid log file extensions that can be used with the Serviço Web de Atualização de Dispositivos. This list can be modified; however, there is no reason to modify the list unless you have a device running Lync Server that creates log files that use a different file extension.</p>
