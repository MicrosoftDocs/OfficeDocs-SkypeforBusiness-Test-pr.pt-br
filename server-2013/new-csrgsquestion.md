...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg398186(v=OCS.15)
ms:contentKeyID: 49305905
ms.date: 05/19/2016
...
Creates a new Response Group question. The Aplicativo Grupo de Resposta uses questions to provide callers with choices, and then takes action based on those choices. Este cmdlet foi introduzido no Lync Server 2010.
