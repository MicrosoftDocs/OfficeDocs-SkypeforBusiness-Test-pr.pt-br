...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ205166(v=OCS.15)
ms:contentKeyID: 49307829
ms.date: 05/19/2016
...
Creates a new Persistent Chat chat room. A chat room is a discussion forum that typically revolves around a specific topic. Este cmdlet foi introduzido no Lync Server 2013.
...
**Painel de Controle do Lync Server:** To create a new Persistent Chat chat room using the Painel de Controle do Lync Server, click **Persistent Chat**, click **Room**, and then click **New**.
