...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ205006(v=OCS.15)
ms:contentKeyID: 49307098
ms.date: 05/19/2016
...
**Painel de Controle do Lync Server:** The functions carried out by the **Set-CsBackupServiceConfiguration** cmdlet are not available in the Painel de Controle do Lync Server.
