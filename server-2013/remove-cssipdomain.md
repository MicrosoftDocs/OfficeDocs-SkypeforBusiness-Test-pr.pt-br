...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg398865(v=OCS.15)
ms:contentKeyID: 49308132
ms.date: 05/19/2016
...
Removes a SIP domain previously configured for use in your organization. SIP domains are domains authorized to send and receive SIP traffic, and are used when assigning SIP addresses to users. Este cmdlet foi introduzido no Lync Server 2010.
