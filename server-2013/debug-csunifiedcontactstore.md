...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ994054(v=OCS.15)
ms:contentKeyID: 52057651
ms.date: 05/19/2016
...
To return a list of all the role-based access control (RBAC) roles that this cmdlet has been assigned to (including any custom RBAC roles that you have created), run the following command from the Interface da linha de comando do Windows PowerShell prompt:

Get-CsAdminRole | Where-Object {$\_.Cmdlets –match "Debug-CsUnifiedContactStore"}

**Painel de Controle do Lync Server:** The functions carried out by the **Debug-CsUnifiedContactStore** cmdlet are not available in the Painel de Controle do Lync Server.
