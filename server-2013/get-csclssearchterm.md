...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ205061(v=OCS.15)
ms:contentKeyID: 49307370
ms.date: 05/19/2016
...
**Painel de Controle do Lync Server:** The functions carried out by the **Get-CsClsSearchTerm** cmdlet are not available in the Painel de Controle do Lync Server.
