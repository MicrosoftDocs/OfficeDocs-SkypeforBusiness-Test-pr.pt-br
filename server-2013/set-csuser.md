...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg398510(v=OCS.15)
ms:contentKeyID: 49307021
ms.date: 05/19/2016
...
Modifies Lync Server properties for an existing user account. Properties can be modified only for accounts that have been enabled for use with Lync Server. Este cmdlet foi introduzido no Lync Server 2010.
