...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg425752(v=OCS.15)
ms:contentKeyID: 49306194
ms.date: 05/19/2016
...
Modifies the property values of an existing Lync Server announcement. Announcements are played when users dial a valid but unassigned phone number. An announcement can be a message (such as "This number is temporarily out of service") or a busy signal. Este cmdlet foi introduzido no Lync Server 2010.
