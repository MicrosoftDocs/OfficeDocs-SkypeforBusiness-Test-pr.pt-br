...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg398592(v=OCS.15)
ms:contentKeyID: 49307178
ms.date: 05/19/2016
...
Returns information about all the user accounts in Serviços de Domínio Active Directory. This includes user accounts that have been enabled for Lync Server as well as accounts that have not been enabled for Lync Server. Este cmdlet foi introduzido no Lync Server 2010.
