...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ619191(v=OCS.15)
ms:contentKeyID: 49308570
ms.date: 05/19/2016
...
Removes one or more collections of centralized logging configuration settings. Centralized logging provides a way for administrators to simultaneously enable or disable event tracing on multiple computers. Este cmdlet foi introduzido no Lync Server 2013.
...
**Painel de Controle do Lync Server:** The functions carried out by the **Remove-CsClsConfiguration** cmdlet are not available in the Painel de Controle do Lync Server.
