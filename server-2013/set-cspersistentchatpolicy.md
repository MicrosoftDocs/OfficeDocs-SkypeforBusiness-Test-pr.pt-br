...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ205192(v=OCS.15)
ms:contentKeyID: 49307881
ms.date: 05/19/2016
...
Modifies an existing Persistent Chat policy. Persistent Chat policies determine whether or not users are allowed access to Persistent Chat chat rooms. Este cmdlet foi introduzido no Lync Server 2013.
...
**Painel de Controle do Lync Server:** To modify an existing Persistent Chat policy using the Painel de Controle do Lync Server, click **Persistent Chat**, click **Persistent Chat Policy**, then double-click the policy to be modified.
