...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ204897(v=OCS.15)
ms:contentKeyID: 49306720
ms.date: 05/19/2016
...
Exports user data in a format that can be imported into Lync Server. The data will be exported as a .ZIP file containing a pair of XML documents. Este cmdlet foi introduzido no Lync Server 2013.
...
**Painel de Controle do Lync Server:** The functions carried out by the **Export-CsUserData** cmdlet are not available in the Painel de Controle do Lync Server.
