...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg398977(v=OCS.15)
ms:contentKeyID: 49308328
ms.date: 05/19/2016
...
Revokes the Lync Server management permissions that have been granted on an Active Directory organizational unit (OU). Este cmdlet foi introduzido no Lync Server 2010.
