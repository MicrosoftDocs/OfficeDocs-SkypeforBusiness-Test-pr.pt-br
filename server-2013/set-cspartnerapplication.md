...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ204755(v=OCS.15)
ms:contentKeyID: 49306203
ms.date: 05/19/2016
...
Modifies an existing partner application. A partner application is any application that Skype for Business Online can directly exchange security tokens with, without having to go through a third-party security token server. Este cmdlet foi introduzido no Lync Server 2013.
...
**Painel de Controle do Lync Server:** The functions carried out by the **Set-CsPartnerApplication** cmdlet are not available in the Painel de Controle do Lync Server.
