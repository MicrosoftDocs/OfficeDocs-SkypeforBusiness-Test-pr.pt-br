...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg425948(v=OCS.15)
ms:contentKeyID: 49306575
ms.date: 05/19/2016
...
Returns information about the server applications in use in your organization. Server applications are applications that are hosted by Lync Server. Este cmdlet foi introduzido no Lync Server 2010.
...
<td><p>Retrieves the server application data from the local replica of the Repositório de Gerenciamento Central rather than from the Repositório de Gerenciamento Central itself.</p></td>
</tr>
</tbody>
</table>
