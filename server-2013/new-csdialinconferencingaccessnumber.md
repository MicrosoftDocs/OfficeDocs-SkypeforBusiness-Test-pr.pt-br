...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg398818(v=OCS.15)
ms:contentKeyID: 49308058
ms.date: 05/19/2016
...
Creates a new dial-in conferencing access number. Dial-in conferencing provides a way for users to use a "regular" telephone, cell phone or other device on the public switched telephone network (PSTN) to join the audio portion of a conference. Este cmdlet foi introduzido no Lync Server 2010.
