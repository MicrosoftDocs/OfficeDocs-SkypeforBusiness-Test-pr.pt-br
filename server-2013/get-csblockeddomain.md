...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg398424(v=OCS.15)
ms:contentKeyID: 49306865
ms.date: 05/19/2016
...
<td><p>Retrieves the blocked domain data from the local replica of the Repositório de Gerenciamento Central rather than from the Repositório de Gerenciamento Central itself.</p></td>
</tr>
</tbody>
</table>
