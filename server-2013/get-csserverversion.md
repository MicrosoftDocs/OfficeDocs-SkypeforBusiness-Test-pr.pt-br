...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Gg398470(v=OCS.15)
ms:contentKeyID: 49306949
ms.date: 05/19/2016
...
Returns server licensing information for a computer running Lync Server. Este cmdlet foi introduzido no Lync Server 2010.
...
That no license key is required for the components installed on the local computer. (Licensing is required only for computers functioning as a Servidor Front-End, a Diretor, or an Servidor de Borda.)
