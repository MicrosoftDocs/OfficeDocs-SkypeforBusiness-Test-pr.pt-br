...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ204896(v=OCS.15)
ms:contentKeyID: 49306709
ms.date: 05/19/2016
...
Modifies an existing Open Authorization (OAuth) server. OAuth servers, also known as security token servers, issue security tokens used in server-to-server authentication and authorization. Este cmdlet foi introduzido no Lync Server 2013.
...
**Painel de Controle do Lync Server:** The functions carried out by the **Set-CsOAuthServer** cmdlet are not available in the Painel de Controle do Lync Server.
