...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ204831(v=OCS.15)
ms:contentKeyID: 49306475
ms.date: 05/19/2016
...
Modifies the property values of an existing Lync Server 2013 meeting room. A meeting room is a conferencing device designed to address video conferencing and collaboration scenarios in small conference rooms. Este cmdlet foi introduzido no Lync Server 2013.
...
Painel de Controle do Lync Server: The functions carried out by the **Set-CsMeetingRoom** cmdlet are not available in the Painel de Controle do Lync Server.
