...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ205350(v=OCS.15)
ms:contentKeyID: 49308384
ms.date: 05/19/2016
...
Removes an existing Persistent Chat add-in. A Persistent Chat add-in is a customized web page that can be embedded within a Persistent Chat client. Este cmdlet foi introduzido no Lync Server 2013.
...
**Painel de Controle do Lync Server:** To remove a Persistent Chat add-in using the Painel de Controle do Lync Server, click **Persistent Chat** and then click **Add-in**. Select the add-in to be removed, click **Edit**, and then click **Delete**.
