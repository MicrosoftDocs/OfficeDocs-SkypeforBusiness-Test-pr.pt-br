...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ945587(v=OCS.15)
ms:contentKeyID: 52057781
ms.date: 06/27/2014
...
Here is a list of terms and definitions that you might find useful as you read through this topic.
  ...
  - Organizational Unit – The Serviços de Domínio Active Directory organizational unit (OU).
...
![Guia de criação de usuários.](images/JJ945587.80d3c17b-7482-4818-8381-1eff8717d2fe(OCS.15).jpg "Guia de criação de usuários.")
...
![Guia de criação de contatos.](images/JJ945587.7508726e-83e6-4878-8edd-114543d9af24(OCS.15).jpg "Guia de criação de contatos.")
...
![Guia de Criação de Listas de Distribuição.](images/JJ945587.0a1d681b-2aea-4724-90d8-efa8a526f600(OCS.15).jpg "Guia de Criação de Listas de Distribuição.")
...
When you click the Create Distribution Lists button, the tool queries Serviços de Domínio Active Directory to see if distribution lists matching the prefix and numbers already exist. The tool will create only the ones that do not already exist. When adding members to these newly created Distribution Lists, it will pick the users from the range specified on the User Creation tab.
...
![Guia de Config de Serviço de Info de Localização.](images/JJ945587.52ea4e9e-d50a-4dc9-982b-31ee5ace4578(OCS.15).jpg "Guia de Config de Serviço de Info de Localização.")
