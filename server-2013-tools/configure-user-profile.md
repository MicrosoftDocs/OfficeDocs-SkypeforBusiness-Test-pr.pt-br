...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ945594(v=OCS.15)
ms:contentKeyID: 52057778
ms.date: 06/27/2014
...
![Guia de Configurações Comuns.](images/JJ945594.c68dcc8f-10f2-499e-95a2-fccbcc206c2f(OCS.15).jpg "Guia de Configurações Comuns.")
...
7.  In **Account Domain**, type the Serviços de Domínio Active Directory domain logon.
...
![Guia geral de cenários.](images/JJ945594.4f046d39-b532-4baf-99a6-c89d1d6d1fcc(OCS.15).jpg "Guia geral de cenários.")
...
![Guia de cenários de voz.](images/JJ945594.28edf664-da59-40b0-9a0e-196f01e9ca86(OCS.15).jpg "Guia de cenários de voz.")
...
2.  In **UC/PSTN Gateway**, specify a value for Load Level. If you select a load level other than **Disabled**, you must supply a value for **PSTN Area Code** by clicking the **Add** button under Mediation Server and PSTN. Verify that you have a route configured for that area code.
    ...
    <tbody>
    <tr class="odd">
    <td>You can use either the Painel de Controle do Lync Server or the Shell de Gerenciamento do Lync Server to verify voice route configuration.</td>
    </tr>
    </tbody>
    </table>
...
![Guia de alcance.](images/JJ945594.65ccf6de-0e8d-47ba-93f3-9dcb39d3fd62(OCS.15).jpg "Guia de alcance.")
...
![Guia de mobilidade.](images/JJ945594.4dd8f3e0-921c-48a5-8b23-2a0330d3c334(OCS.15).jpg "Guia de mobilidade.")
...
![Guia de resumo.](images/JJ945594.c675e869-8ded-4195-8c2a-68d844fc96ad(OCS.15).jpg "Guia de resumo.")
...
![Declaração de criação de arquivos.](images/JJ945594.00dc1e92-bfba-48e7-9568-b97ad864491e(OCS.15).jpg "Declaração de criação de arquivos.")
